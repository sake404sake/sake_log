  ...
  try {
    ...
    if (googleUserId) {
      ...
      if (cloudSettings) {
        ...
        if (cloudTime > localTime || !localSettingsUpdatedAt) {
          console.log('[GoogleDriveSync] Cloud settings are newer or local is fresh. Overwriting local settings.');
